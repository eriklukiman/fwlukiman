...
use \Lukiman\Modules\GeneralXml;
...
class TesXml extends GeneralXml {
	...
	public function do_Param ($param) {
		...
		$this->rootAttributes = [ 'rootElementName' => 'lukiman',
		'_attributes' => [
			'xmlns' => 'https://localhost/test/me']];
		$this->xmlVersion = '1.1';
		//$this->processingInstruction = ['xml-stylesheet' => 'type="text/xsl" href="base.xsl"'];
		//$this->useXmlDeclaration = false;
